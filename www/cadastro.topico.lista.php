...
try {
	...
	if (count($topicos)==0){
		$model->assign_block_vars('naoencontrado', array('MSG' => 'Nenhum tópico cadastrado!'));
	}else{
		$model->assign_block_vars('paginacao', array('CONTADOR' => "Total de Tópicos cadastrados: ".$i));
	}
