...
for ($i=0; $i<count($instituicoes); $i++) {
	...
	$sessionFacade->enviaEmailProvaAluno('corrigida');
}
/*
$mail             = new PHPMailer();
...
$data = date('d/m/Y H:i');
$body      = '<h3>Envio de Emails de Correção de Prova Concluído! '.$data.'</h3>';

$mail->From       = "testenetweb@gmail.com";
$mail->FromName   = "TesteNet";
$mail->Subject    = "TesteNet - Envio de Emails de Correção de Prova Concluído - ".$data;
